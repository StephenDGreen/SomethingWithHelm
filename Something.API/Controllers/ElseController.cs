...
namespace Something.API.Controllers
{
    ...
    public class ElseController : ControllerBase
    {
        ...
        private readonly ILogger<ElseController> logger;

        public ElseController(ISomethingElseCreateInteractor createInteractor, ISomethingElseReadInteractor readInteractor, ISomethingElseUpdateInteractor updateInteractor, ISomethingElseDeleteInteractor deleteInteractor, ILogger<ElseController> logger)
        {
